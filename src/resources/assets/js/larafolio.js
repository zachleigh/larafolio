...
Vue.component('header-lines', require('./components/HeaderLines.vue'));
...
Vue.component('line-preview', require('./components/Previews/LinePreview.vue'));
...
Vue.component('text-block', require('./components/TextBlock.vue'));
Vue.component('text-line', require('./components/TextLine.vue'));
Vue.component('text-lines', require('./components/TextLines.vue'));
